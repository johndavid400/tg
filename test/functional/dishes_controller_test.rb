...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { cook_time: @dish.cook_time, event_id: @dish.event_id, name: @dish.name, start_time: @dish.start_time }
    end
  ...
  test "should update dish" do
    put :update, id: @dish, dish: { cook_time: @dish.cook_time, event_id: @dish.event_id, name: @dish.name, start_time: @dish.start_time }
    assert_redirected_to dish_path(assigns(:dish))
  end
